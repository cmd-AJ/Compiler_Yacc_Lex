...
inline void yyerror(const char *str){
    extern int yylineno;
    { std::cout << str << " REVISAR LINEA " << yylineno << std::endl; }
};
...
{
      -2,    -9,    18,    24,    -2,    -9,    -9,     3,    16,    -9,
      -9,    16,    16,    16,    16,    16,    -9,    -9,     9,     9,
      13,    13,    -9,    -9
};
...
{
      18,     1,     2,    19,    20,    21,    22,    23,    11,    12,
      13,    14,    15,    16,    11,    12,    13,    14,    15,     1,
      17,    14,    15,     8,     9,    10
};

static const yytype_int8 yycheck[] =
{
       8,     3,     4,    11,    12,    13,    14,    15,     5,     6,
       7,     8,     9,    10,     5,     6,     7,     8,     9,     3,
       4,     8,     9,     5,     0,     4
};
...
#line 52 "simple_language.y"
                                    { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1184 "y.tab.c"
    break;

  case 13: /* expression: expression '/' expression  */
#line 53 "simple_language.y"
                                    { (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); }
#line 1190 "y.tab.c"
    break;

  case 14: /* expression: expression '=' expression  */
#line 54 "simple_language.y"
                                    { yyerror("NO SE PUEDE ASIGNAR NUMEROS A OTROS NUMEROS"); }
#line 1196 "y.tab.c"
    break;
